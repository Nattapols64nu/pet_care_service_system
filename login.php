    ...
    <nav class="navbar navbar-lg navbar-light shadow-sm " style="background-color:#343434;">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-0">
                <a href="adminlogin.php" class="text-white " style="background-color:#343434;padding-right: 30px; text-align: right;">เข้าสู่ระบบ </a>
            </div>
        </div>
    ...
    <div class="container" >
        ...
        <?php endif ?>
            <div class="mb-3">
                ...
                <button type="submit" name="login_user" class="btn1" >เข้าสู่ระบบ</button><br>
                <a id="register-link" href="register.php" class="btn2">ลงทะเบียน</a>
        </form>
        <hr>
    </div>
