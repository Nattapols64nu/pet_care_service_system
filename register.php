    ...
    <div class="container" >
        ...
        <form action="registerdb.php" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="tel" class="form-control" name="phone" oninput="validatePhoneNumber(event)"maxlength="10" required>
                <label for="facebook" class="form-label">Facebook</label>
                <input type="text" class="form-control" name="facebook" required>  
                <label for="line" class="form-label">Line</label>
                <input type="text" class="form-control" name="line" required> <br>
                <button type="submit" name="reg_user" class="btn1" >ลงทะเบียน</button>
            </div>
        </form>
        <hr>
    </div>
